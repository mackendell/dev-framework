...
- **Framework-native skills** (`dev`, `checkpoint`, `design-gate`, `model-routing`, `check-upstream`) are ours; keep them consistent with the routes named in `skills/dev/SKILL.md`.
